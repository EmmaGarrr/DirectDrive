...
from app.api.v1 import routes_admin_auth, routes_admin_users, routes_admin_files, routes_admin_storage, routes_admin_storage_management, routes_admin_monitoring, routes_admin_config, routes_admin_notifications, routes_admin_reports
...
app.include_router(routes_admin_storage_management.router, prefix="/api/v1/admin", tags=["Admin Storage Management"])
